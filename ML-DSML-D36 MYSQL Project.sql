...
CREATE TABLE Branch (Branch_no INT PRIMARY KEY, Manager_Id INT, Branch_address VARCHAR(250),
    ...
    CREATE TABLE Employee (Emp_Id INT PRIMARY KEY, Emp_name VARCHAR(150), Position VARCHAR(70),
    Salary DECIMAL(10, 2), Branch_no INT, FOREIGN KEY (Branch_no) REFERENCES Branch(Branch_no));
...
VALUES
    ...
    CREATE TABLE Books ( ISBN VARCHAR(20) PRIMARY KEY, Book_title VARCHAR(250), Category VARCHAR(85),
    Rental_Price DECIMAL(10, 2), Status VARCHAR(3), Author VARCHAR(90), Publisher VARCHAR(110));
   ...
   CREATE TABLE Customer (Customer_Id INT PRIMARY KEY, Customer_name VARCHAR(150), Customer_address VARCHAR(250),
    Reg_date DATE);
 ...
 SELECT * FROM Customer;
  ...
  CREATE TABLE ReturnStatus (Return_Id INT PRIMARY KEY, Return_cust INT, Return_book_name VARCHAR(250),
